...
from config import CSV_OUTPUT_PATH, DOT_CIRCLE_COLOR, DOT_CIRCLE_RADIUS, DOT_CIRCLE_THICKNESS, DOT_DENSITY_HEATMAP_IMAGE_PATH, DOT_DIAMETER_DISTRIBUTION_IMAGE_PATH, DOT_SIZE_DISTRIBUTION_IMAGE_PATH, HEATMAP_GRID_CELL_SIZE_MM, HIST_BIN_WIDTH_MM, HIST_MAX_MM, HIST_MIN_MM, HISTOGRAM_IMAGE_PATH, IMAGE_PATH, LOWER_PURPLE_HSV, MAX_DOT_AREA_PX, MIN_DOT_AREA_PX, SCALE_BAR_MM, SCALE_BAR_ROI_COORDS, SHOW_DETECTED_DOTS_IMAGE, UPPER_PURPLE_HSV
from detectDotsHsv import detect_dots_hsv
